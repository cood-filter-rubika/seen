...
def http():
    ...
    try:
        ...
        pass
    try:
        zxcvv = requests.get("https://drnonsafe.xyz/ddos/http.txt",timeout=8)
        for okeys in zxcvv.content.decode().split("\n"):
            hit.append(okeys)
    except:
        pass
    try:
...
def socks4():
    ...
    try:
        ...
        pass
    try:
        zxcvv = requests.get("https://drnonsafe.xyz/ddos/socks4.txt",timeout=8)
        for okeys in zxcvv.content.decode().split("\n"):
            hit.append(okeys)
    except:
        pass
...
def socks5():
    ...
    try:
        ...
        pass
    try:
        zxcvv = requests.get("https://drnonsafe.xyz/ddos/socks5.txt",timeout=8)
        for okeys in zxcvv.content.decode().split("\n"):
            hit.append(okeys)
    except:
        pass
...
CoDeD By : @CYROSIF , channel : @CYROSIF""")
